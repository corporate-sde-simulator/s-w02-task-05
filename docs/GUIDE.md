...
> **Welcome to Service-Track Week 2, Task 5!**
...
| `src/scannerService.js` | Main source code - **has bugs to fix** |
| `src/uploadPipeline.js` | Supporting code - **may also have bugs** |
| `tests/uploadPipeline.test.js` | Test file - **add your tests here** |
