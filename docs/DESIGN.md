# Architecture Decision Record - File upload and virus scan pipeline
...
Implement File upload and virus scan pipeline using industry-standard patterns appropriate for nodejs and our platform requirements.
